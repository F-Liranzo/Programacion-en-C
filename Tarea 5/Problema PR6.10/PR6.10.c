...
const int DEP = 3;
const int ANIO = 8;
void Lectura(float [MES][DEP][ANIO], int, int, int); // El compilador de aun error con la letra 'ñ' asi que la intercambie por NI //
void Funcion1(float [MES][DEP][ANIO], int, int, int);
void Funcion2(float [MES][DEP][ANIO], int, int, int); /* Prototipos de funciones. */
